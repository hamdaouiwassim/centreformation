		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="#" class="course-img" style="background-image: url({{ asset('uploads/formations')}}/{{ $f->affiche }});">
						</a>
						<div class="desc">
							<h3><a href="#">{{ $f->titre }}</a></h3>
							<p>{{ Str::limit($f->description, 100, '...')  }}</p>

                            <a href="/formation/{{ $f->id }}" class="btn btn-primary btn-sm btn-course">Details</a>
                            <a style="color:white" class="btn btn-primary btn-sm btn-course" > {{ $f->prix }} DTT</a>
						</div>
					</div>
                </div>
                @endforeach
