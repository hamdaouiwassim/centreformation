                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table no-wrap v-middle mb-0">
                                        <thead>
                                            <tr class="border-0">
                                                <th class="border-0 font-14 font-weight-medium text-muted"> Formation </th>
                                                <th class="border-0 font-14 font-weight-medium text-muted"> Etat
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-top-0 px-2 py-4">
                                                     <a href="{{ route('deleteInscription',['id' => $i->id ])}}" class="btn btn-danger">supprimer</a>
