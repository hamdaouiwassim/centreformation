                            ...
                            <div class="card-body">
                                <div class="row col-md-12">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <div class="card" >
                                                    <img src="{{ asset('uploads/evenements')}}/{{ $e->affiche }}" class="card-img-top" alt="...">
                                                    <div class="card-body">
                                                    <h5 class="card-title">{{ $e->titre }}</h5>
                                                    <p class="card-text">{{ Str::limit($e->description, 100, '...')  }}</p>
                                                    <a href="/formation/{{ $e->id }}" class="btn btn-primary mr-2">Details</a>
                                                    <a style="color:white" class="btn btn-success" > {{ $e->lieu }} DTT</a>
                                                    </div>
                                            </div>
                                        </div>
                                      @endforeach
