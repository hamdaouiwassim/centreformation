                            ...
                            <div class="card-body">
                                <div class="row col-md-12">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <div class="card" >
                                                    <img src="{{ asset('uploads/actualites')}}/{{ $a->affiche }}" class="card-img-top" alt="...">
                                                    <div class="card-body">
                                                    <h5 class="card-title">{{ $a->titre }}</h5>
                                                    <p class="card-text">{{ Str::limit($a->description, 100, '...')  }}</p>
                                                    <a href="/formation/{{ $a->id }}" class="btn btn-primary mr-2">Details</a>
