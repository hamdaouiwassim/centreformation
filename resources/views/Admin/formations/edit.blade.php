        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    ...
                    <li class="list-divider"></li>
                    <li class="nav-small-cap"><span class="hide-menu">Statistiques</span></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    <h4 class="card-title">Formations   > Modifier </h4>
                                ...
                                <div class="table-responsive">
                                   <form action="{{route('updateFormation')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="idformation" value={{ $formation->id }} >
                                            ...
                                            <textarea type="text" name="description"  class="form-control">{{ $formation->description }}</textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="1" name="duree"  class="form-control" value="{{ $formation->duree }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select  name="etat"  class="form-control" >
                                                        <option value="">-- Selectionner etat du formation --</option>
                                                        <option value="Phase D'inscription">Phase D'inscription</option>
