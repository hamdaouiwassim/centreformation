            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item selected"> <a class="sidebar-link sidebar-link active" href="/admin/actualites"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    <h4 class="card-title">Actualites   > Ajouter </h4>
                                    
                                </div>
                                <hr />
                                <div class="table-responsive">
                                <form action="{{ route('addActualite') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                   <input type="hidden" name="idactualite"  >
