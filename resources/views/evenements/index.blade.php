...
<html>
	...
	<div id="fh5co-course">
		<div class="container">
			...
			<div class="row">
                @foreach ($evenements as $f)
				<div class="col-md-6 animate-box">
					<div class="course">
						<a href="#" class="course-img" style="background-image: url({{ asset('uploads/evenements')}}/{{ $f->affiche }});">
						</a>
						<div class="desc">
							<h3><a href="#">{{ $f->titre }}</a></h3>
							<p>{{ Str::limit($f->description, 100, '...')  }}</p>

                            <a href="/evenement/{{ $f->id }}" class="btn btn-primary btn-sm btn-course">Details</a>
