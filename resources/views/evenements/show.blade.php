                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10 text-right menu-1">
                                                <ul>
                                                    ...
                                                    @if ( Auth::user() ) 
                                                    <li class="btn-cta"><a href="/home"><span>dashboard</span></a></li> 
                                                    @else 
                                                    <li class="btn-cta"><a href="/login"><span>Connexion</span></a></li>
                            ...
                            <div class="container">
                                <div class="row animate-box">
                                    <div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
                                        <h2>Inscription aux evenement</h2>
                                       <p>
                                           {{ $evenement->titre }}
                                       </p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="card" >
                                        ...
                                        <img src="{{ asset('uploads/evenements')}}/{{ $evenement->affiche }}" style='width:100% !important'>
                                        <div class="card-body">
                                        <a href="#" class="btn btn-success  labelPrix"> {{ $evenement->lieu }} </a>
                                        <h3 class="card-title">{{ $evenement->titre }} ( <span style="font-size: 18px" > {{ $evenement->duree  }} Heures </span> ) </h3>
                                        
                                     
                                        <hr />
                                        <p class="card-text">{{ $evenement->description  }}</p>
                                        
                                        <h6 >le {{ $evenement->date  }} a {{ $evenement->heure  }}</h6>
